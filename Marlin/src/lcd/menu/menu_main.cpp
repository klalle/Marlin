...
void menu_main() {
  ...
  if (busy) {
    ...
    SUBMENU(MSG_Kalle_GotoHoming, gotoHomeMenu);// GCODES_ITEM(MSG_Kalle_MakeThisHome, PSTR("G92 X0 Y0 Z0"));
    SUBMENU(MSG_Kalle_Homing, homingMenu);
    SUBMENU(MSG_Kalle_DisableStepperMenu, disableStepperMenu);
    ...
    //SUBMENU(MSG_TEMPERATURE, menu_temperature); //Kalle
    ...
    SUBMENU(MSG_CONFIGURATION, menu_configuration); //Kalle moved bellow custom
